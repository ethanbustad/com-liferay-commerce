...
import com.liferay.commerce.item.selector.criterion.SimpleSitetemSelectorCriterion;
...
public class SiteCommerceChannelTypeDisplayContext
	...
	public List<Group> getGroups() throws PortalException {
		...
		String[] siteGroupIds = StringUtil.split(
			commerceChannel.getTypeSettings());

		for (String siteGroupId : siteGroupIds) {
	...
	public String getItemSelectorUrl() throws PortalException {
		...
		SimpleSitetemSelectorCriterion simpleSitetemSelectorCriterion =
			new SimpleSitetemSelectorCriterion();

		simpleSitetemSelectorCriterion.setDesiredItemSelectorReturnTypes(
			Collections.<ItemSelectorReturnType>singletonList(
				new UUIDItemSelectorReturnType()));

		PortletURL itemSelectorURL = _itemSelector.getItemSelectorURL(
			requestBackedPortletURLFactory, "sitesSelectItem",
			simpleSitetemSelectorCriterion);
	...
	protected long[] getCheckedGroupIds() throws PortalException {
		return ListUtil.toLongArray(getGroups(), Group.GROUP_ID_ACCESSOR);
	}
