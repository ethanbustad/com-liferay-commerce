...
public class EditCommerceCatalogUsersMVCActionCommand
	...
	protected void addCommerceCatalogUsers(ActionRequest actionRequest)
		...
		long[] commerceCatalogUserIds = StringUtil.split(
			ParamUtil.getString(actionRequest, "commerceCatalogUserIds"), 0L);
	...
	protected void doProcessAction(
		...
		try {
			...
			String redirect = getSaveAndContinueRedirect(
				actionRequest,
				ParamUtil.getLong(actionRequest, "commerceCatalogId"));
