...
public class CommerceChannelPersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		newCommerceChannel.setCommerceCatalogId(RandomTestUtil.nextLong());

		newCommerceChannel.setName(RandomTestUtil.randomString());

		newCommerceChannel.setActive(RandomTestUtil.randomBoolean());

		newCommerceChannel.setConsumerType(RandomTestUtil.randomString());

		newCommerceChannel.setConsumerTypeSettings(RandomTestUtil.randomString());
		...
		Assert.assertEquals(existingCommerceChannel.getCommerceCatalogId(),
			newCommerceChannel.getCommerceCatalogId());
		Assert.assertEquals(existingCommerceChannel.getName(),
			newCommerceChannel.getName());
		Assert.assertEquals(existingCommerceChannel.isActive(),
			newCommerceChannel.isActive());
		Assert.assertEquals(existingCommerceChannel.getConsumerType(),
			newCommerceChannel.getConsumerType());
		Assert.assertEquals(existingCommerceChannel.getConsumerTypeSettings(),
			newCommerceChannel.getConsumerTypeSettings());
	}
	...
	protected OrderByComparator<CommerceChannel> getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create("CommerceChannel",
			...
			"commerceCatalogId", true, "name", true, "active", true,
			"consumerType", true, "consumerTypeSettings", true);
	}
	...
	protected CommerceChannel addCommerceChannel() throws Exception {
		...
		commerceChannel.setCommerceCatalogId(RandomTestUtil.nextLong());

		commerceChannel.setName(RandomTestUtil.randomString());

		commerceChannel.setActive(RandomTestUtil.randomBoolean());

		commerceChannel.setConsumerType(RandomTestUtil.randomString());

		commerceChannel.setConsumerTypeSettings(RandomTestUtil.randomString());
